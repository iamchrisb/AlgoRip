...
public class HeapSort implements Sort {
	 ...
	 * 
	 * Linker Nachfolger von i: 2*(i+1) – 1 
	 * Rechter Nachfolger von i: 2*(i+1) 
	 * Vorgänger von i: (i-1)/2
	 */
	@Override
	...
	private <T extends Comparable<T>> void heapify(T[] ar, int i, int till) {
	...
	/**
	 * moves the biggest value 
	 * into the root
	 * 
	 * @param ar
	 */
	private <T extends Comparable<T>> void buildHeap(T[] ar) {
		int k = ar.length - 1;
		for (int i = k; i >= 0; i--) {
			heapify(ar, i, k);
		}

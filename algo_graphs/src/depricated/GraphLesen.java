...
//	 @return der Graph mit Standardgewicht 1 für die Kanten
//	 */
//	public static <V extends Vertex2d, E extends Edge<V>> Graph<V,E> FileToWeightedGraph2d(String dat, boolean directed) {
//		int[][] GArray = FileToWeightedGraphArray(dat);
//		int n = GArray[0][0];
//		int m = GArray[0][1];
...
//			int idxb = GArray[i][1];
//			int w = GArray[i][2];
//			V a = (V) G.getVertex(idxa);
//			V b = (V) G.getVertex(idxb);
//			G.addEdge((E) new Edge<Vertex2d>(a,b,w));
//			if (!directed) {
//				G.addEdge((E) new Edge<Vertex2d>(b,a,w));
//			}
//		}
//		return G;
//	}
